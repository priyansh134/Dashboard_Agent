...
const ChatPage = () => {
  ...
  const downloadDashboard = async () => {
    ...
    showNotification('📄 Generating PDF with high-quality chart images...', 'info');
        ...
        for (let i = 0; i < chartsOnThisPage.length; i++) {
          ...
          if (chartInstance) {
            try {
              ...
              // Use ECharts' built-in image export - much better than html2canvas
              ...
              console.log(`✅ Successfully captured chart ${startChartIndex + i + 1}`);
                      ...
                      <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div className="flex items-center justify-between">
                          <div className="text-blue-700">
                            ...
                            <p className="text-sm">Click "Generate Report" to download a high-quality PDF with crystal-clear chart images.</p>
                          </div>
                          <button
                            onClick={downloadDashboard}
                            disabled={isGeneratingPDF}
