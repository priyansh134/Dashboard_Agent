...
const ChatPage = () => {
  ...
  const downloadDashboard = () => {
        ...
        <body>
          <div class="dashboard-container">
            <div class="dashboard-header">
              ...
              <p class="dashboard-subtitle">Generated on ${new Date().toLocaleDateString()} at ${new Date().toLocaleTimeString()}</p>
            </div>
            
            <div class="charts-grid">
              ${pinnedCharts.map((chart, index) => `
                <div class="chart-item">
                  <div class="chart-title">Chart ${index + 1}: ${chart.data[0]?.[chart.customization.yAxis] || 'Data'} Analysis</div>
                  <div class="chart-query">"${chart.query}"</div>
                  <div class="chart-container">
                    <div>
                      <div style="font-size: 3rem; margin-bottom: 10px;">📈</div>
                      <div>Chart visualization would appear here</div>
                      <div style="margin-top: 10px; font-size: 0.8rem;">
                        ${chart.data[0]?.[chart.customization.yAxis]} vs ${chart.data[0]?.[chart.customization.xAxis]} 
            ...
            <div class="dashboard-footer">
              <p>📊 Dashboard contains ${pinnedCharts.length} pinned charts • Generated by Data Analytics Platform</p>
              <p>💡 Tip: Use Ctrl+P to print or save as PDF</p>
            </div>
          </div>
        </body>
      </html>
    ...
    setTimeout(() => {
      ...
      if (confirm('Dashboard opened in new window. Would you like to print/save it now?')) {
                      ...
                      <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div className="flex items-center justify-between">
                          <div className="text-blue-700">
                            ...
                            <p className="text-sm">Click "Download Dashboard" to generate a printable version with all your pinned charts.</p>
                          </div>
                          <button
                            onClick={downloadDashboard}
