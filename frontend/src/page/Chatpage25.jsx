  ...
  const createPowerPointPresentation = async (insights) => {
    try {
      ...
      pptx.title = 'Analytics Dashboard Presentation';
        ...
        // Bottom-right small geometric elements (much smaller, well within boundaries)
        titleSlide.addShape(pptx.ShapeType.rect, {
          x: 8.2, y: 5, w: 0.8, h: 1.2,
          fill: colors.primary,
          line: { width: 0 },
          rotate: 215
        });
        ...
        for (let i = 0; i < pinnedCharts.length; i++) {
          ...
          chartSlide.addShape(pptx.ShapeType.rect, {
            x: 0.6, y: 0.2, w: 0.25, h: 0.4,
            fill: colors.lightBlue,
            line: { width: 0 },
            rotate: 35
          });
          
          // Bottom-right tiny geometric elements
          chartSlide.addShape(pptx.ShapeType.rect, {
            x: 8.8, y: 6, w: 0.4, h: 0.6,
            fill: colors.primary,
            line: { width: 0 },
            rotate: 215
          });
