        ...
        for (let i = 0; i < chartsOnThisPage.length; i++) {
          ...
          if (chartElement) {
            try {
              ...
              pdf.addImage(imgData, 'JPEG', x, imageY, imgWidth, imgHeight);
              ...
              pdf.text('❌ Chart image could not be captured', x + 5, y + queryHeight + 25);
            }
          } else {
            ...
            pdf.setTextColor(108, 117, 125);
            pdf.rect(x, y + queryHeight + 15, imgWidth, imgHeight, 'S');
            pdf.text('📊 Chart preview unavailable', x + 5, y + queryHeight + 25);
          }
        }
