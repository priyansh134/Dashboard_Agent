...
import { BarChart3, TrendingUp, Database, Zap, Shield, Users, ArrowRight, CheckCircle, Star, Activity } from 'lucide-react';
            ...
            >
              <AnimatePresence>
                {!isLoggedIn && showGoogleLogin && (
                  ...
                  >
                    <div className="bg-white/8 backdrop-blur-xl rounded-3xl p-10 border border-white/10 shadow-corporate">
                      <h3 className="text-2xl font-display text-white mb-3 tracking-tight">Start Your Enterprise Trial</h3>
                      <p className="text-gray-300 font-body mb-8 text-base">Join industry leaders transforming their data strategy</p>
                      <div className="mb-6">
                        <GoogleLogin
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl overflow-hidden shadow-xl">
                  ...
                  <div className="bg-white border-b border-gray-200 px-6 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-sm text-gray-600 font-body">Alisson</div>
                    </div>
                  </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-gray-500 text-sm font-body">
                © 2024 Dashboard Agent. All rights reserved. | SOC 2 Type II Certified
              </p>
            </div>
          </div>
        </div>
